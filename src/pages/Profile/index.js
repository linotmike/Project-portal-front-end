  ...
  return (
    <div className="row d-flex flex-column justify-content-center align-self-center align-items-center profile-container h-100 p-2 m-auto">
      <div className="col-12 d-flex flex-column justify-content-center align-items-center profile-inner-container p-2">
        ...
        <div className="col-12 d-flex align-items-center justify-content-center profile-cards-container p-2">
          <div className='d-flex flex-column justify-content-start align-items-center profile-proficiencies-container p-2 mx-2'>
          ...
          <div className="d-flex flex-column align-items-center profile-works-container p-2 mx-2">
          ...
          <div className="d-flex flex-column align-items-start profile-stats-container p-3 mx-2">
